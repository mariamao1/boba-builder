...
the words the store actually uses.
    ...
    python3 -m unittest discover -s tests -t .     # 137 tests at the time; 228 now
...
137, up from 49 (228 once Task 4 landed). The new ones are in `tests/test_options.py`, mostly against a
