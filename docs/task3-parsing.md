...
the words the store actually uses.
    ...
    python3 -m unittest discover -s tests -t .     # 137 tests at the time; 227 now
...
137, up from 49 (227 once Task 4 landed). The new ones are in `tests/test_options.py`, mostly against a
